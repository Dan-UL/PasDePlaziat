...
#levels(data$locationOfContents) <- c("3","2","1")
#data$locationOfContents <- factor(data$locationOfContents, levels = c( "1", "2", "3"))
...
levels(data$numberOfFloorsInTheInsuredBuilding) <- c("2","3","1")
data$numberOfFloorsInTheInsuredBuilding <- factor(data$numberOfFloorsInTheInsuredBuilding, levels = c( "1", "2", "3"))
