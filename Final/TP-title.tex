...
\textsc{\LARGE Rapport final}\\[1.0cm] % LAISSER TP OU METTRE UN VRAI TITRE
...
%%% MODIFIER ICI (DATE)%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\textsc{\large 16 avril 2023}\\[1cm] % Date, change the \today to a set date if you want to be precise
